package com.example.administrator.myui.RecycleViewCursorAdapter;
...
import com.example.administrator.myui.RecycleViewCursorAdapter.CursorFilter;
 ...
 */
public abstract class BaseAbstractRecycleCursorAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> implements Filterable,
         ...
         */
        public abstract void onBindViewHolder(T holder, Cursor cursor);
